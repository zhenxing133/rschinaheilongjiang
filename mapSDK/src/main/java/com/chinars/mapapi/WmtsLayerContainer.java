...
import com.chinars.mapapi.AbstractLayerContainer.ImageTask;
...
public class WmtsLayerContainer extends AbstractLayerContainer {
	...
	private Vector<ImageTask> unfinishTask=new Vector<WmtsLayerContainer.ImageTask>();
	 ...
	 */
	public WmtsLayerContainer(MapView mapView,WmtsLayer baseMaplayer ,Bitmap placeHolder){
...
//    			int urid=OfflineMapFileManager.getTileNumURI(tileX, tileY, zoomLevel);
    			...
    			if(baseMapTile==null){
    				...
    				if(baseMapTile==null){
    					...
    					bufferCanvas.drawBitmap(baseMapTile, srcRect, dstRect, paint); //绘制上一层的1/4个瓦片
    				}
    			}else{
